...
class ListtoolBase
{
    ...
    {
        $this->db->setStatement("INSERT INTO t:lw_info_portals_listtool (portal_id, db_links, db_files, dir_files, list_count, lw_date) VALUES (:portal_id, :db_links, :db_files, :dir_files, :list_count, :lw_date) ");
        $this->db->bindParameter("portal_id", "i", $id);
    ...
    {
        $this->db->setStatement("UPDATE t:lw_info_portals_listtool SET portal_id = :portal_id, db_links = :db_links, db_files = :db_files, dir_files = :dir_files, list_count = :list_count WHERE portal_id = :portal_id AND id = :id ");
