...
class lw_portals_table_search extends lw_plugin
{
    ...
    public function __construct()
    {
        ...
        $autoloader = new \LwPortalsTableSearch\Services\Autoloader();
    }
    ...
    public function buildPageOutput()
    {
        ...
        $controller = new \LwPortalsTableSearch\Controller\Frontend();
