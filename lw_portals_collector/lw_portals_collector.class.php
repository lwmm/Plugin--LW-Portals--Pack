...
class lw_portals_collector extends lw_plugin
{
    ...
    public function __construct()
    {
        ...
        $autoloader = new \LwPortalsCollector\Services\Autoloader();
    }
    ...
    public function buildPageOutput()
    {
        ...
        $controller = new \LwPortalsCollector\Controller\Frontend();
